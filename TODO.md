...
- [x] Create weather service using Open-Meteo API (server/weather.ts)
- [x] Add weather tRPC routes (current, forecast, historical)
- [x] Write comprehensive weather service tests (7 tests passing)
- [x] Create WeatherIcon component for displaying weather conditions
- [x] Create WeatherCard component for displaying current weather and spray window assessment
