CREATE TYPE "public"."api_key_permission" AS ENUM('read', 'write', 'delete', 'admin');--> statement-breakpoint
...
CREATE TYPE "public"."audit_action" AS ENUM('create', 'update', 'delete', 'login', 'logout', 'role_change', 'status_change', 'export', 'import', 'view');--> statement-breakpoint
CREATE TYPE "public"."audit_entity_type" AS ENUM('user', 'customer', 'personnel', 'job', 'site', 'equipment', 'product', 'service_plan', 'maintenance_task', 'organization', 'integration', 'job_status');--> statement-breakpoint
...
CREATE TYPE "public"."personnel_role" AS ENUM('applicator', 'technician', 'driver', 'pilot', 'ground_crew', 'manager', 'dispatcher');--> statement-breakpoint
