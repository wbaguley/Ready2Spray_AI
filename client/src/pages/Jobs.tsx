                  ...
                  {formData.productId && (
                    <div className="mb-2 p-3 bg-green-50 border border-green-200 rounded-md">
                      <div className="flex items-center gap-2 text-sm text-green-800">
                        ...
                        <span className="font-medium">EPA Product Linked:</span>
                        <span>{formData.chemicalProduct}</span>
                        {formData.reEntryInterval && (
                          <span className="ml-2 text-xs">• REI: {formData.reEntryInterval}</span>
                        )}
                      </div>
                    </div>
                  )}
