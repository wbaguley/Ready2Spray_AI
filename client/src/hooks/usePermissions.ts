...
const ROLE_PERMISSIONS: Record<string, Permission[]> = {
  ...
  manager: [
    // Managers can manage jobs, personnel, and view reports
    "view_dashboard",
    "view_jobs",
    "create_jobs",
    "edit_jobs",
  ...
  technician: [
    // Technicians can view and update job status, manage equipment
    "view_dashboard",
    "view_jobs",
    "edit_jobs",
    "view_calendar",
  ...
  pilot: [
    // Pilots can view flight board and update job status
    "view_dashboard",
    "view_jobs",
    "edit_jobs",
    "view_calendar",
  ...
  sales: [
    // Sales can manage customers and create quotes
    "view_dashboard",
    "view_jobs",
    "create_jobs",
    "view_calendar",
